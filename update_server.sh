...
mkdir -p ./backups
BACKUP_FILE="./backups/sparetrack_pre_update_$(date +%Y%m%d_%H%M%S).sql"
...
echo ""
echo "[3/8] Building production frontend web assets (Vite)..."
npm run build
...
echo ""
echo "[5/8] Clearing and warming up Laravel caches..."
...
echo ""
echo "[7/8] Restarting Docker application services..."
