    ...
    <div class="container-fluid p-0">
      ...
      <div class="py-3 px-4 bg-white border-bottom shadow-sm rounded mb-4 d-flex flex-wrap justify-content-between align-items-center gap-2">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            <h4 class="mb-0 fw-bold text-dark">Executive Management Reports &amp; Analytics</h4>
            <small class="text-muted">Secondary KPIs &bull; Production Flow &bull; Daily Parts Movements &bull; Priority Map &bull; Supplier Quality</small>
          </div>
        </div>
        <div class="d-flex gap-2">
          <button @click="fetchReportData" class="btn btn-outline-primary btn-sm text-nowrap" :disabled="loading">
        ...
        <div class="card-body p-3 bg-light rounded">
          <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-3">
              ...
              <select v-model="filters.project_id" @change="onFilterChange" class="form-select form-select-sm">
            ...
            <div class="col-6 col-md-2">
              ...
              <select v-model="filters.side" @change="onFilterChange" class="form-select form-select-sm">
            ...
            <div class="col-6 col-md-2">
              ...
              <input type="date" v-model="filters.date_from" @change="fetchReportData" class="form-control form-control-sm" />
            </div>

            <!-- Date Range To -->
            <div class="col-6 col-md-2">
              <label class="form-label small fw-bold mb-1">To Date</label>
              <input type="date" v-model="filters.date_to" @change="fetchReportData" class="form-control form-control-sm" />
            </div>
      ...
      <!-- Scope / Context Summary Line -->
      <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4 px-1">
        <div class="d-flex align-items-center gap-2">
          <span class="badge bg-dark px-2.5 py-1.5 fs-7">
            <i class="fas fa-crosshairs me-1 text-primary"></i> Scope: {{ currentScopeLabel }}
          </span>
          <span v-if="filters.side" class="badge bg-primary-subtle text-primary border border-primary-subtle px-2 py-1 fs-7">
            Side: {{ filters.side }}
          </span>
          <span v-if="filters.date_from || filters.date_to" class="badge bg-light text-dark border px-2 py-1 fs-7">
            Date: {{ filters.date_from || 'Beginning' }} to {{ filters.date_to || 'Today' }}
          </span>
        </div>
        <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1 extra-small">
          <i class="fas fa-database me-1"></i> Live PostgreSQL Calculation
        </span>
      </div>

      <!-- ========================================================================= -->
      <!-- SECTION 1: PRODUCTION FLOW & OPERATIONAL VELOCITY                          -->
      <!-- ========================================================================= -->
      <div class="mb-4">
        <div class="d-flex align-items-center gap-2 mb-3">
          <h5 class="fw-bold mb-0 text-dark">
            <i class="fas fa-stream text-primary me-2"></i>Production Flow &amp; Operational Velocity
          </h5>
          <span class="badge bg-light text-dark border extra-small">Executive Analytics</span>
        </div>
          ...
          <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                <div>
                  <h6 class="card-title fw-bold mb-0 text-dark d-flex align-items-center">
              ...
              <div class="card-body p-3 text-center">
                ...
                <div class="position-relative d-inline-block my-2" style="width: 130px; height: 130px;">
                  ...
                  <div class="position-absolute top-50 start-50 translate-middle text-center">
                    <h3 class="fw-bold mb-0 text-dark">{{ readinessScore }}%</h3>
      ...
      <!-- ========================================================================= -->
      <!-- SECTION 2: DAILY DEPARTMENT PARTS MOVEMENT MATRIX                         -->
      <!-- ========================================================================= -->
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
          <div>
            ...
            <small class="text-muted">5-Active-Day Rolling Window &bull; Real-time Shop Floor Transfers</small>
          </div>
      ...
      <!-- ========================================================================= -->
      <!-- SECTION 3: PARTS PRIORITY MAP & CRITICAL BOTTLENECKS                       -->
      <!-- ========================================================================= -->
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
          <div class="d-flex align-items-center gap-2">
      ...
      <!-- ========================================================================= -->
      <!-- SECTION 4: SUPPLIER ACCURACY & QUALITY COST PRESSURE                       -->
      <!-- ========================================================================= -->
...
// Computed Current Scope Label
const currentScopeLabel = computed(() => {
  if (!filters.value.project_id) return 'All Active Projects';
  const found = [...activeProjectsList.value, ...completedProjectsList.value].find(p => String(p.id) === String(filters.value.project_id));
  return found ? (found.project_code || found.name) : 'Selected Project';
});

// Computed Filtered Modal Parts
...
const onFilterChange = () => {
  priorityProjectFilter.value = filters.value.project_id || '';
  fetchReportData();
};
...
const resetFilters = () => {
  ...
  priorityProjectFilter.value = '';
  prioritySearchQuery.value = '';
  priorityTierFilter.value = '';
...
const fetchPriorityMap = async () => {
  try {
    const projId = priorityProjectFilter.value || filters.value.project_id || '';
    const res = await axios.get(`/api/v1/dashboard/priority-map?project_id=${projId}`);
...
const renderVelocityChart = () => {
  try {
    ...
    console.warn('Error rendering velocity chart:', e);
  }
};
...
const fetchInitialProjectsList = async () => {
  try {
    ...
    console.warn('Could not fetch initial projects list for reports:', e);
  }
};
